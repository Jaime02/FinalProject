...
public class Shader {
    ...
    void bindUniforms(GL2 gl, Scene scene,Renderer renderer, Scene s, MeshEntity me, 
	...
	shaderProgramID = createProgramFromBuffer(gl, vProgram, fProgram);
	getUniforms( gl );
        ...
        if (shader != 0) {
            ...
            if (compiled.get() == 0) {
                ...
                if (length > 0) {
                    ...
                    buf.get(b);
                    System.out.println("Program : " + fProgram);
